...
const Header = () => {
  ...
  return (
    <>
      <button
        className={`scroll-top scroll-to-target scroll-top-two ${isSticky ? "open" : ""} flex items-center justify-center`}
        data-target="html"
      ...
      <header id="home">
        <div
          ...
          className={isSticky ? "active-height" : ""}
        ></div>
        <div
          id="sticky-header"
          className={`tg-menu-area menu-area ${isSticky ? "sticky-menu" : ""}`}
        >
              ...
              <div className="col-12">
                <div className="menu-wrap">
                  <nav className="menu-nav">
                    ...
                    <div
                      className="mobile-nav-toggler d-md-none"
      ...
      <div className={`mobile-menu ${isMobileMenuOpen ? "open" : ""}`}>
        <nav className="menu-box">
          ...
          <div className="menu-outer">
            <ul className="navigation mobile-navigation-list">
              <li className={isActive("/")}>
                <Link to="/" onClick={closeMobileMenu}>
                  Home
                </Link>
              ...
              <li>
                <a href="#product-showcase" onClick={handleMobileProductClick}>
                  Product
                </a>
              </li>
              <li className={isActive("/about")}>
          ...
          <div className="social-links">
            <ul className="clearfix">
              ...
              <li>
                <a href="https://api.whatsapp.com/send?phone=+919511424676&text=Hello, I want to know more about your service.">
